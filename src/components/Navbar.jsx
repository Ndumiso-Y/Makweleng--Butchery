        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Link to="/" className="flex items-center transform hover:scale-105 transition-transform duration-300">
              <img src={logo} alt="Makweleng Butchery Logo" className="h-12 md:h-14 w-auto" />
            </Link>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-1">
            <Link
              ...
              className={`font-semibold px-3 py-1.5 rounded-full transition-all duration-300 transform hover:scale-105 ${location.pathname === '/' ? 'bg-rusty text-white shadow-lg' : 'text-brew hover:bg-chai/20 hover:text-rusty'}`}
            >
              Home
            </Link>
            <Link
              ...
              className={`font-semibold px-3 py-1.5 rounded-full transition-all duration-300 transform hover:scale-105 ${location.pathname === '/about' ? 'bg-rusty text-white shadow-lg' : 'text-brew hover:bg-chai/20 hover:text-rusty'}`}
            >
              About
            </Link>
            <Link
              ...
              className={`font-semibold px-3 py-1.5 rounded-full transition-all duration-300 transform hover:scale-105 ${location.pathname === '/services' ? 'bg-rusty text-white shadow-lg' : 'text-brew hover:bg-chai/20 hover:text-rusty'}`}
            >
              Services
            </Link>
            <Link
              ...
              className={`font-semibold px-3 py-1.5 rounded-full transition-all duration-300 transform hover:scale-105 ${location.pathname === '/braai-buy' ? 'bg-rusty text-white shadow-lg' : 'text-brew hover:bg-chai/20 hover:text-rusty'}`}
            >
              Buy & Braai
            </Link>
            <Link
              ...
              className={`font-semibold px-3 py-1.5 rounded-full transition-all duration-300 transform hover:scale-105 ${location.pathname === '/promotions' ? 'bg-rusty text-white shadow-lg' : 'text-brew hover:bg-chai/20 hover:text-rusty'}`}
            >
              Promotions
            </Link>
            ...
            <Link
              ...
              className={`font-semibold px-3 py-1.5 rounded-full transition-all duration-300 transform hover:scale-105 ${location.pathname === '/contact' ? 'bg-rusty text-white shadow-lg' : 'text-brew hover:bg-chai/20 hover:text-rusty'}`}
            >
              Contact
            </Link>
          </nav>
          ...
          <div className="hidden md:block">
            <a href="https://wa.me/27766386581" onClick={handleOrderNowClick} className="bg-gradient-to-r from-rusty to-orange-600 hover:from-orange-700 hover:to-rusty text-white font-bold px-4 py-2 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center space-x-2">

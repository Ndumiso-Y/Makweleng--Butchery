      ...
      <div className="container-pad py-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <Link to="/" className="text-3xl font-black tracking-tight transform hover:scale-105 transition-transform duration-300 text-mocha">
              <span className="bg-gradient-to-r from-rusty to-orange-600 bg-clip-text text-transparent">Makweleng</span>
            </Link>
          </div>
          ...
          <div className="hidden md:block">
            <a href="https://wa.me/27724746047" className="bg-gradient-to-r from-rusty to-orange-600 hover:from-orange-700 hover:to-rusty text-white font-bold px-6 py-3 rounded-full shadow-lg transform hover:scale-105 transition-all duration-300 flex items-center space-x-2">

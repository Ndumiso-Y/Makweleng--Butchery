...
export default function Contact() {
  const handleFormSubmit = (e) => {
    trackFormSubmit('contact_form', { form_name: 'request_call_back' })
    // Form will continue to submit normally to FormSubmit
  }
  return (
        ...
        <div className="relative container-pad text-center flex items-center justify-center min-h-[80vh]">
          <div className="max-w-5xl text-white">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 drop-shadow-2xl">
              Contact <span className="text-rusty">Us</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a href="https://wa.me/27766386581" className="bg-rusty hover:bg-mocha text-white font-bold px-8 py-4 rounded-full transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2">
              ...
              <a href="tel:+27766386581" className="bg-white bg-opacity-20 backdrop-blur-sm hover:bg-opacity-30 text-white font-bold px-8 py-4 rounded-full border-2 border-white transition-all duration-300 transform hover:scale-105">
                Call Direct
              </a>
            </div>
          </div>
        ...
        <div className="container-pad">
          <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <h2 className="text-3xl font-bold mb-8 text-chai">Get In Touch</h2>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-chai">Address</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-chai">Email</h3>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-chai">Phone</h3>
                    <p className="text-gray-600">+27 76 638 6581</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-bold text-lg text-chai">Hours</h3>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              ...
              <form action="https://formsubmit.co/info@makwelengroup.co.za" method="POST" onSubmit={handleFormSubmit} className="space-y-6">
      ...
      <section className="py-16 bg-brew">
        <div className="container-pad">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold mb-8 text-center text-white">Find Us</h2>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-4 text-white">Can't find us? Call us for directions!</h3>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <a href="tel:+27766386581" className="btn-primary">
                  Call +27 76 638 6581
                </a>
                <a href="https://wa.me/27766386581" className="border-2 border-white text-white px-8 py-3 rounded-full font-semibold hover:bg-white hover:text-brew transition-all duration-300">
